...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'Wake-word detection and voice-command recognition for Flutter on iOS.'
  s.description      = <<-DESC
...
Flutter over method/event channels and dart:ffi.
  ...
  s.source           = { :path => '.' }
  # Classes/voice_wakeword_ios.cpp pulls in ../../src/voice_wakeword.cpp, the
  ...
  s.frameworks = 'Foundation', 'AVFoundation', 'Accelerate', 'CoreML'

...
const ::flutter::StandardMessageCodec& WakeWordAudioHostApi::GetCodec() {
  return ::flutter::StandardMessageCodec::GetInstance(&PigeonInternalCodecSerializer::GetInstance());
}

// Sets up an instance of `WakeWordAudioHostApi` to handle messages through the `binary_messenger`.
void WakeWordAudioHostApi::SetUp(
  ::flutter::BinaryMessenger* binary_messenger,
  WakeWordAudioHostApi* api) {
  WakeWordAudioHostApi::SetUp(binary_messenger, api, "");
}
...
void WakeWordAudioHostApi::SetUp(
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.voice_command_kit.WakeWordAudioHostApi.checkOrRequestPermission" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          api->CheckOrRequestPermission([reply](ErrorOr<bool>&& output) {
            if (output.has_error()) {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.voice_command_kit.WakeWordAudioHostApi.startListening" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          api->StartListening([reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.voice_command_kit.WakeWordAudioHostApi.stopListening" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          api->StopListening([reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.voice_command_kit.WakeWordAudioHostApi.isListening" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const ::flutter::MessageReply<EncodableValue>& reply) {
        try {
          api->IsListening([reply](ErrorOr<bool>&& output) {
            if (output.has_error()) {
              reply(WrapError(output.error()));
              return;
            }
...
EncodableValue WakeWordAudioHostApi::WrapError(std::string_view error_message) {
...
EncodableValue WakeWordAudioHostApi::WrapError(const FlutterError& error) {
  return EncodableValue(EncodableList{
